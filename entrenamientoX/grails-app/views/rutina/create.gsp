...
<html>
	...
	<body>
		<a href="#create-rutina" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-rutina" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:rutinaInstance, action:'save']" >
				<fieldset class="form">
