...
<html>
	...
	<body>
		<a href="#list-rutina" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-rutina" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="rutina.ejercicio.label" default="Ejercicio" /></th>
				...
				<g:each in="${rutinaInstanceList}" status="i" var="rutinaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${rutinaInstance.id}">${fieldValue(bean: rutinaInstance, field: "ejercicio")}</g:link></td>
