		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="altura" title="${message(code: 'usuario.altura.label', default: 'Altura')}" />
						...
						<g:sortableColumn property="puntaje" title="${message(code: 'usuario.puntaje.label', default: 'Puntaje')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usuarioInstance.id}">${fieldValue(bean: usuarioInstance, field: "altura")}</g:link></td>
					
						<td><g:formatDate date="${usuarioInstance.fechaNacimiento}" /></td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "nombre")}</td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "puntaje")}</td>
