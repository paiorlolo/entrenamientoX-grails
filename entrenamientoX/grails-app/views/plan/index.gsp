		...
		<div id="list-plan" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="plan.rutina.label" default="Rutina" /></th>
					
						<th><g:message code="plan.usuario.label" default="Usuario" /></th>
				...
				<g:each in="${planInstanceList}" status="i" var="planInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${planInstance.id}">${fieldValue(bean: planInstance, field: "rutina")}</g:link></td>
					
						<td>${fieldValue(bean: planInstance, field: "usuario")}</td>
