			...
			<ol class="property-list rutina">
				...
				<li class="fieldcontain">
					<span id="ejercicio-label" class="property-label"><g:message code="rutina.ejercicio.label" default="Ejercicio" /></span>
						...
						<span class="property-value" aria-labelledby="ejercicio-label"><g:link controller="ejercicio" action="show" id="${rutinaInstance?.ejercicio?.id}">${rutinaInstance?.ejercicio?.encodeAsHTML()}</g:link></span>
